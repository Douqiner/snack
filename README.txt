/*--------------------------------介绍--------------------------------*/
这是同济大学面向对象编程课程的大作业，c++中需要有easyX库才能编译运行
附有可执行程序
...
为方便检查，qin用户已经是打完了坤坤之旅的用户，并且有其中第二关和第三关（最后一关）的存档；sheng用户还没有打完，但也有其中第二关和第三关（最后一关）的存档，建议使用这个存档快速体验坤坤之旅。当然，第三关也不是那么好打的，如果不会可以看坤坤之旅的介绍。
